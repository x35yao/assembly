    ...
    for individual in individuals:
        ...
        for bpindex, bp in enumerate(bodyparts):
            for j in range(triangulate.shape[-1]):
                df_3d.iloc[j][individual, bp, "x"] = triangulate[0, bpindex, 0, j]
                df_3d.iloc[j][individual, bp, "y"] = triangulate[0, bpindex, 1, j]
                df_3d.iloc[j][individual, bp, "z"] = triangulate[0, bpindex, 2, j]
    if destfolder == None:
